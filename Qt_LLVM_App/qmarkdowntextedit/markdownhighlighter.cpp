 ...
 * @return
 */
MarkdownHighlighter::MarkdownHighlighter(QTextDocument *parent, HighlightingOptions highlightingOptions, int theTextSize)
...
void MarkdownHighlighter::initTextFormats(int defaultFontSize) {
    ...
    format = QTextCharFormat();
    aFont.setPointSize(defaultFontSize);
    format.setFont(aFont);
...
void MarkdownHighlighter::highlightHeadline(const QString &text) {
    ...
    if (headingFound) {
        ...
        if (headingLevel > 0) {
            ...
            maskedFormat.setFontPointSize(8);
...
void MarkdownHighlighter::highlightSubHeadline(const QString &text,
    ...
    if (previousBlockState() == H1 || previousBlockState() == H2 ||
        ...
        currentMaskedFormat.setFontPointSize(8);
...
//        }
        if ((previousBlockState() != CodeBlock &&
            ...
            HighlighterState progLang = HighlighterState::CodeCpp;//_langStringToEnum.value(lang);
